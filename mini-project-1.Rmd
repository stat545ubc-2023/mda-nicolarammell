...
**Explanation**: Now that I am aware of the missing data in this dataset, I will move on to some exploratory visualization of the data. However, I will first create a new variable that I am interested in exploring: `year_planted`. I will create this variable based on the `date_planted` variable, by splitting up the date into multiple columns. This exercise makes sense because the dataset provides the date in the year-month-day format. However, I would like to have this data split up into individual variables, so that I can easily work with the 'year_planted' column as a numeric variable. Similarly, this may also be desirable in order to work with the 'month_planted' column, irregardless of year.   
