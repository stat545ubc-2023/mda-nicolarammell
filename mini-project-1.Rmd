...
1: vancouver_trees 2: flow_sample 3: building_permits 4: cancer_sample
...
For Task 2, I will complete Exercises 3, 2, 1, and 4.
...
```{r}
# How many NAs per variable? Can you plot this?
summary(trees)

```

Summary: (what did I find out?)
...
```{r}
# Create new columns: year planted, no. years since planted
...
```{r}
# Plot distribution of no. years since planted (all species)
# Plot distribution of tree species (count vs species - combine spp and genus)
...
```{r}
# diameter vs years since planted
...
1. What are the most rare and most common tree species in Vancouver, BC?
2. Do tree communities differ by neighbourhood?
3. How does species richness vary by neighboorhood?
