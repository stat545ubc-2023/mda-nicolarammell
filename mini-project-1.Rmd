...
I have decided to use the `vancouver_trees` dataset for my project. Of the four datasets
that I explored, this dataset had the most observations, with 146,611 rows of data. This dataset also contains numerous variables of interest, with a mixture of character data (such as species names and street names) and numeric data (such as tree diameter). Overall, I chose this dataset because of its large size, completeness, and because I am ultimately interested in learning more about the trees of Vancouver. Specifically, I am interested in how tree biodiversity and species identity varies over space. 
...
What are the most common and rare tree species of Vancouver? What proportion of Vancouver tree species are native to the region?
